...
> [!IMPORTANT]
> The bundled mihomo TUN requires administrator privileges. The Windows desktop requests administrator rights at startup and manages mihomo directly. Allow `mihomo.exe` through Windows Firewall on first TUN launch.
>
